var building = function(parentLayer, imgSrc, width, height, posX, posY, parallaxOffsetX, parallaxOffsetY)
{
  var mainBG = false;
  var that = this;
  ...
  that.image.src = imageLoc+ parmCheck("buildings/" +imgSrc,"blank.png");  
